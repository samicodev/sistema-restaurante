    ...
    if (empty($nombre) || empty($correo) || empty($rol)) {
        ...
        if (empty($id)) {
            ...
            if (empty($pass)) {
                ...
                $pass = md5($_POST['pass']);
                $query = mysqli_query($conexion, "SELECT * FROM usuarios where usuario = '$correo' AND estado = 1");
                ...
                if ($result > 0) {
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO usuarios (nombre,usuario,rol,pass) values ('$nombre', '$correo', '$rol', '$pass')");
                    if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE usuarios SET nombre = '$nombre', usuario = '$correo' , rol = '$rol' WHERE id = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    Usuario Modificado
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="correo" class="form-control" placeholder="Ingrese un usuario" name="correo" id="correo">
                    </div>
